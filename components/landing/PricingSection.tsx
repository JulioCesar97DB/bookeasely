      ...
      <div className="container mx-auto px-4 space-y-16">
          ...
          {pricingPlans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${plan.gradientColor} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg`} />
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <p className="text-muted-foreground">
            All plans include unlimited bookings, customer notifications, and basic analytics.
          </p>
          <p className="text-sm text-muted-foreground">
            Need something custom? <Button variant="link" className="p-0 h-auto text-primary">Contact us</Button> for enterprise solutions.
          </p>
        </div>
      </div>
    </section>
